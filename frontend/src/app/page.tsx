...
import { Terminal, Cpu, Database, Shield, ArrowRight, Activity } from "lucide-react";
    ...
    <div className="relative min-h-screen bg-cyber-dark text-white overflow-hidden flex flex-col scanline">
      ...
      <header className="relative z-10 border-b border-white/5 bg-black/40 backdrop-blur-md px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="/waitlist">
            <CyberButton variant="purple" size="sm">
              JOIN WAITLIST
            </CyberButton>
          </Link>
          <Link href="/login">
          ...
          <a href="https://github.com/yachitguliani/personal-assitant" target="_blank" rel="noopener noreferrer">
      ...
      <main className="relative z-10 flex-1 max-w-6xl w-full mx-auto px-6 py-12 flex flex-col lg:flex-row items-center gap-12 justify-center">
        ...
        <div className="flex-1 flex flex-col gap-6 text-center lg:text-left">
          ...
          >
            ...
            <Link href="/waitlist">
              <CyberButton variant="purple" size="lg">
                JOIN EARLY ACCESS
              </CyberButton>
            </Link>
            <Link href="/login">
      ...
      <footer className="relative z-10 border-t border-white/5 bg-black/60 py-4 px-6 text-center text-[10px] font-mono text-white/30">
        NEURON OS v1.0.0-Beta |{" "}
        <Link href="/waitlist" className="text-cyber-purple hover:text-cyber-cyan transition-colors">
          Join Waitlist
        </Link>{" "}
        | LICENSED UNDER MIT | EST. 2026
      </footer>
    </div>
  );
}
